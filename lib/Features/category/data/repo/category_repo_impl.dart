...
import 'package:pesticides/Features/category/data/data_source/category_data_source.dart';
...
class CategoryRepoImpl implements CategoryRepo{
  ...
  @override
  Future<Either<Failure, UserAndAdminModelEntity>> readUserOrAdminFromFireStore() async{
  ...
  @override
  Future<Either<Failure, void>> editUserData(UserAndAdminModelEntity user) async{
