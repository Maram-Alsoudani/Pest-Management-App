...
import 'package:pesticides/Features/register/domain/repositories/register_repo.dart';
...
class RegisterUseCase{
  ...
  Future<Either<Failure, void>> registerFireStore(String image,String type,String userName,String phone,  String email,  String password ) async {
    return registerRepo.registerFireStore(image, type, userName, phone, email, password);
  }
}